    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                <div class="card-body">
                    <h1 class="card-title"><b>{{ $serie->Titulo}}</b></h1>
                    <h3 class="card-subtitle mb-2 text-muted">{{ $serie->Creacion }}</h3>
                </div>
            ...
            <div class="col-md-12">
                ...
                <form action="/series/comment" method="POST">
                    @csrf
            ...
            <div class="col-md-12">
                ...
                @if (count($serie->Comments) == 0 || $serie->Comments == null || empty($serie->Comments))
